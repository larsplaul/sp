...
public class Login {
    ...
    public Response login(String jsonString) throws JOSEException, PasswordStorage.CannotPerformOperationException, PasswordStorage.InvalidHashException, AuthenticationException {
